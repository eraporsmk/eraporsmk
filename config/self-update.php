...
return [
    ...
    */
    ...
    'version_installed' => '5.0.0',//env('SELF_UPDATER_VERSION_INSTALLED', '5.0.1'),
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'eraporsmk'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'eraporsmk'),
            'repository_url' => 'https://github.com/eraporsmk/eraporsmk.git',
            'download_path' => env('SELF_UPDATER_DOWNLOAD_PATH', '/eRaporSMK/dataweb/update'),
        ],
        'http' => [
            'type' => 'http',
            'repository_url' => env('SELF_UPDATER_REPO_URL', 'http://localhost/updater/zip_file/'),
            'pkg_filename_format' => env('SELF_UPDATER_PKG_FILENAME_FORMAT', 'webapp-v_VERSION_'),
            'download_path' => env('SELF_UPDATER_DOWNLOAD_PATH', 'downloads'),
        ],
    ],
