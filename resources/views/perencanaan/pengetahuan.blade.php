...
@section('title_postfix', 'Perencanaan Penilaian Pengetahuan |')
@section('content_header')
    <h1>Perencanaan Penilaian Pengetahuan</h1>
@stop
@section('content_header_right')
<a href="{{url('perencanaan/tambah-pengetahuan')}}" class="btn btn-success pull-right">Tambah Data</a>
@stop
@section('content')
...
$(document).ready( function () {
	var table = $('#datatable').DataTable( {
		...
		"processing": true,
        "serverSide": true,
        "ajax": "{{ url('perencanaan/list-rencana/1') }}",
		"columns": [
