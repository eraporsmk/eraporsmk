...
@section('title_postfix', 'Tambah Perencanaan Keterampilan |')
@section('content_header')
    <h1>Tambah Perencanaan Keterampilan</h1>
@stop
    ...
    <form action="{{ route('simpan_perencanaan') }}" method="post" class="form-horizontal" id="form">
		...
		<div class="col">
			<div class="col-sm-6">
				...
				<div class="form-group" id="teknik_penilaian_show" style="display:none;">
					<label for="teknik_penilaian" class="col-sm-5 control-label">Teknik Penilaian</label>
					<div class="col-sm-7">
						<select name="teknik_penilaian" class="select2 form-control" id="teknik_penilaian" style="width:100%">
							<option value="">== Pilih Teknik Penilaian ==</option>
						</select>
					</div>
				</div>
				<div class="form-group" id="bobot_show" style="display:none;">
					<label for="bobot" class="col-sm-5 control-label">Bobot</label>
					<div class="col-sm-7">
						<input name="bobot" class="form-control" id="bobot" type="text" />
						<input name="bobot_value" class="form-control" id="bobot_value" type="hidden" />
					</div>
				</div>
			</div>
		</div>
