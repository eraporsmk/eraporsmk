...
@section('title_postfix', 'Perencanaan Penilaian Kurikulum Pusat Keunggulan |')
@section('content_header')
    <h1>Perencanaan Penilaian Kurikulum Pusat Keunggulan</h1>
@stop
@section('content_header_right')
<a href="{{url('perencanaan/tambah-pk')}}" class="btn btn-success pull-right">Tambah Data</a>
@stop
@section('content')
...
$(document).ready( function () {
	...
	var oTable = $('#datatable').DataTable( {
        ...
        "serverSide": true,
        "ajax": {
			"url": "{{ url('perencanaan/list-rencana/3') }}",
			"data": function (d) {
