...
<table border="0" width="100%">
	<tr>
		...
		<td>{{CustomHelper::nama_guru($rencana_ukk->guru_internal->gelar_depan, $rencana_ukk->guru_internal->nama, $rencana_ukk->guru_internal->gelar_belakang)}} ({{$sekolah->nama}})</td>
	</tr>
	<tr>
		<td>Penguji Eksternal<br /><i>External Assessor</i></td>
		<td>{{CustomHelper::nama_guru($rencana_ukk->guru_eksternal->gelar_depan, $rencana_ukk->guru_eksternal->nama, $rencana_ukk->guru_eksternal->gelar_belakang)}} ({{($rencana_ukk->guru_eksternal->dudi) ? CustomHelper::nama_guru($rencana_ukk->guru_eksternal->dudi->gelar_depan, $rencana_ukk->guru_eksternal->dudi->nama, $rencana_ukk->guru_eksternal->dudi->gelar_belakang) : '-'}})</td>
	</tr>
</table>
</div>
@endsection