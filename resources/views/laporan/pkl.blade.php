		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" class="form-control" name="lokasi_prakerin[]" id="lokasi_prakerin" value="{{($siswa->prakerin) ? $siswa->prakerin->lokasi_prakerin : ''}}" /></td>
					<td><input type="number" class="form-control" name="lama_prakerin[]" value="{{($siswa->prakerin) ? $siswa->prakerin->lama_prakerin : ''}}" /></td>
					<td><input type="text" class="form-control" name="keterangan_prakerin[]" value="{{($siswa->prakerin) ? $siswa->prakerin->keterangan_prakerin : ''}}" /></td>
				</tr>
				@endforeach
			</tbody>
		</table>
