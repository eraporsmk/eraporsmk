...
@section('title_postfix', 'Wirausaha Peserta Didik |')

@section('content_header')
    <h1>Tambah Data Wirausaha Peserta Didik</h1>
@stop
...
@section('content')
    ...
    @endif
<form action="{{ route('laporan.tambah_kewirausahaan') }}" method="post" class="form-horizontal" id="form">
	{{ csrf_field() }}
