<table class="table" border="1">
	...
	@foreach($get_siswa as $siswa)
		...
		<tr>
			...
			@foreach($all_pembelajaran as $pembelajaran)
			<?php
			$nilai = $siswa->nilai_rapor_legger()->where('nilai_rapor.pembelajaran_id', $pembelajaran->pembelajaran_id)->where('nilai_rapor.anggota_rombel_id', $siswa->anggota_rombel_id)->first();
			if($nilai){
